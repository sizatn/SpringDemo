...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	public static List readTxTFileToDataList(String fileName, String encoding, boolean isLostFistLine, String splitStr) throws Exception {
		File file = new File(fileName);
		...
		try {
			...
			if (isLostFistLine) {
				reader2.readLine();
				while ((linedate = reader2.readLine()) != null) {
					String[] lineStr = linedate.split(splitStr);
					List list = Arrays.asList(lineStr);
					dataList.add(list);
				}
			} else {
				while ((linedate = reader2.readLine()) != null) {
